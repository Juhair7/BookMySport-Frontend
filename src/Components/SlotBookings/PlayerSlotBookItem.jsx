...
import { Sunrise, Sunset, Star, ChevronRight, ChevronLeft } from 'lucide-react';
import axios from 'axios';
import { Home } from 'lucide-react';
import { useNavigate } from 'react-router';
import { apiConfig } from '../../Constants/ApiConfig'

const PlayerSlotBookItem = (props) => {
    ...
    const handleBooking = (arenaId) => {
        navigate(`/bookslot/${arenaId}`)
    }
            ...
            <div className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                ...
                <div className="p-6 pt-3">
                    <button
                        ...
                        onClick={() => handleBooking(arena.id)}
                    >
                        Book Now
                    </button>
                </div>
...
export default PlayerSlotBookItem