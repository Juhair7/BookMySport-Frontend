...
const ForgotPassword = () => {
    ...
    const handleForgotPassword = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:8090/api/forgotpassword', {}, { headers })
    ...
    const handleVerifyOTP = async (e) => {
        ...
        const response = await axios.post('http://localhost:8090/api/verifyOtpforforgotpassword', {}, { headers })
