...
import { History, CalendarDays, Trophy,PersonStanding } from 'lucide-react';
...
const SportForCustomGame = (props) => {
  ...
  const handleBooking = async () => {
    ...
    const loadingToastId = toast.loading('Creating your game', {
      duration: Infinity,
      position: 'top-right'
    });
    ...
    try {
      ...
      const responseForSlotBooking = await axios.post(`${apiConfig.customGames}/bookcustomgame`, {
      ...
      if (dataFromSlotBooking.success) {
        toast.success('Custom game has been created', {
          duration: 3000,
          position: "top-right"
        })
        setTimeout(() => {
              ...
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="p-4 md:p-5">
                  <ol className="relative border-s border-gray-200 dark:border-gray-600 ms-3.5 mb-4 md:mb-5">
                    ...
                    <li className="mb-10 ms-8">
                      <span className="absolute flex items-center justify-center w-6 h-6 bg-gray-100 rounded-full -start-3.5 ring-8 ring-white dark:ring-gray-700 dark:bg-gray-600 mt-1">
                        <PersonStanding color='white' size={"20px"} />
                      </span>
                      <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Number of Players</h3>
                      <time className="block mb-3 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">{numberOfPlayers}</time>
                    </li>
                    <li className="ms-8">
                      <span className="absolute flex items-center justify-center w-6 h-6 bg-gray-100 rounded-full -start-3.5 ring-8 ring-white dark:ring-gray-700 dark:bg-gray-600 mt-1">
                        <Trophy color='white' size={"20px"} />
        ...
        <div className="tour-receipt">
          ...
          <div className="tour-receipt-select" style={{ width: "445px", }}>
            ...
            <Box
              component="form"
              sx={{
                '& > :not(style)': { m: 1, width: '25ch', marginLeft: "0px" },
              }}
              noValidate
              autoComplete="off"
            >
              <TextField id="outlined-basic" label="Number of players" variant="filled" type='number' onChange={handleNumberOfPlayers}/>
            </Box>
...
export default SportForCustomGame